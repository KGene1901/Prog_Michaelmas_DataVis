...
export default function define(runtime, observer) {
    ...
    const fileAttachments = new Map([
        ["unicef_data.json", new URL("https://raw.githubusercontent.com/KGene1901/Prog_Michaelmas_DataVis/master/unicef_data.json",
            import.meta.url)]
    ]);
    main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
    main.variable(observer()).define(["md"], function(md) {
        return (
            md `# UNICEF: Strategic Plans and Statistics 2018
...
Click to zoom in or out.`
    ...
    main.variable(observer("data")).define("data", ["FileAttachment"], function(FileAttachment) {
        return (
            FileAttachment("unicef_data.json").json()
        )
    });
